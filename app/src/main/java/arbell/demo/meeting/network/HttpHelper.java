...
public class HttpHelper {
    ...
    public static final String DEFAULT_SERVER = "http://192.168.1.100";
    public static String URL_BASE = DEFAULT_SERVER + "/app/";
    public static String URL_SERVER = DEFAULT_SERVER;
